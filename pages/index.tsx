          ...
          <Head>
            ...
            <motion.main>
                <motion.div className={styles.titleContainer}>
                    ...
                    <h3 className={styles.subTitle}>현재까지 등록된 학생 : 120명</h3>
                </motion.div>
                    <AnimateSharedLayout>
                        <motion.div className={styles.classContent} layout>
                            <ClassContainer classNum="1" student="홍현희 이지효 한가인 이린 장사무엘 이민서 최금서"/>
                            <ClassContainer classNum="2" student="하예솔 고석영 김시현 문소아 조예준 장선아 이창우 염정윤 이보람"/>
                            <ClassContainer classNum="3" student="이시은 강진아 안다경 이서정 나정균 정현지 정광현 김정후 이시안"/>
                            <ClassContainer classNum="4" student="황승주 이다은 원인안 이서후 이예은 최서현 최성우 김승하 조서영 김솔리"/>
                            ...
                            <ClassContainer classNum="8" student="이정헌 김주하 강세림 박형준 최서현 안시언 박현서"/>
                            ...
                            <ClassContainer classNum="12" student="김초아 한사라 가윤 김수민 이지원 강민재 박경은 김송연 정다연 정은유 윤사랑 김래언"/>
